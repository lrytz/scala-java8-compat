...
extends StepsIntLikeIndexed[StepsIntRange](_i0, _iN) {
  ...
  protected def semiclone(half: Int) = new StepsIntRange(underlying, i0, half)
}
...
extends StepsLikeIndexed[T, StepsAnyNumericRange[T]](_i0, _iN) {
  ...
  protected def semiclone(half: Int) = new StepsAnyNumericRange[T](underlying, i0, half)
}
...
extends StepsIntLikeIndexed[StepsIntNumericRange](_i0, _iN) {
  def nextInt() = if (hasNext()) { val j = i0; i0 += 1; underlying(j) } else throwNSEE
  protected def semiclone(half: Int) = new StepsIntNumericRange(underlying, i0, half)
}
...
extends StepsLongLikeIndexed[StepsLongNumericRange](_i0, _iN) {
  ...
  protected def semiclone(half: Int) = new StepsLongNumericRange(underlying, i0, half)
}
